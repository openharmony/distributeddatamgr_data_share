...
using ResultCode = OHOS::DistributedShare::DataShare::ISharedResultInterfaceCode;
...
private:
    ...
    static constexpr Handler handlers[static_cast<uint32_t>(ResultCode::FUNC_BUTT)] {
