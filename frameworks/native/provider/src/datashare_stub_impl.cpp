...
int DataShareStubImpl::AddQueryTemplate(const std::string &uri, int64_t subscriberId, Template &tpl)
{
    return 0;
}

int DataShareStubImpl::DelQueryTemplate(const std::string &uri, int64_t subscriberId)
{
    return 0;
}

std::vector<OperationResult> DataShareStubImpl::Publish(
    const Data &data, const std::string &bundleName)
{
...
std::vector<OperationResult> DataShareStubImpl::SubscribeRdbData(
    const std::vector<std::string> &uris, const TemplateId &templateId, const sptr<IDataProxyRdbObserver> &observer)
{
    return std::vector<OperationResult>();
}

std::vector<OperationResult> DataShareStubImpl::UnSubscribeRdbData(
    const std::vector<std::string> &uris, const TemplateId &templateId)
{
    return std::vector<OperationResult>();
}

std::vector<OperationResult> DataShareStubImpl::EnableSubscribeRdbData(
    const std::vector<std::string> &uris, const TemplateId &templateId)
{
    return std::vector<OperationResult>();
}

std::vector<OperationResult> DataShareStubImpl::DisableSubscribeRdbData(
    const std::vector<std::string> &uris, const TemplateId &templateId)
{
    return std::vector<OperationResult>();
}

std::vector<OperationResult> DataShareStubImpl::SubscribePublishedData(
    const std::vector<std::string> &uris, int64_t subscriberId, const sptr<IDataProxyPublishedDataObserver> &observer)
{
    return std::vector<OperationResult>();
}

std::vector<OperationResult> DataShareStubImpl::UnSubscribePublishedData(
    const std::vector<std::string> &uris, int64_t subscriberId)
{
    return std::vector<OperationResult>();
}

std::vector<OperationResult> DataShareStubImpl::EnableSubscribePublishedData(
    const std::vector<std::string> &uris, int64_t subscriberId)
{
    return std::vector<OperationResult>();
}

std::vector<OperationResult> DataShareStubImpl::DisableSubscribePublishedData(
    const std::vector<std::string> &uris, int64_t subscriberId)
{
    return std::vector<OperationResult>();
}
