...
class DataShareStubImplNormalTest : public testing::Test {
public:
...
void DataShareStubImplNormalTest::SetUpTestCase(void)
{
...
void DataShareStubImplNormalTest::TearDownTestCase(void)
{
...
void DataShareStubImplNormalTest::SetUp(void) {}
void DataShareStubImplNormalTest::TearDown(void) {}

/**
 * @tc.name: NormalApp_Silent_Insert_Test001
 * @tc.desc: Verify silent access Insert operation behavior when caller is normal app and provider not in allowList
 * @tc.type: FUNC
 ...
 * @tc.expect:
    ...
    2. Insert operation return DATA_SHARE_ERROR(-1)
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Silent_Insert_Test001, TestSize.Level0)
{
    LOG_INFO("NormalApp_Silent_Insert_Test001::Start");
    ...
    LOG_INFO("NormalApp_Silent_Insert_Test001::End");
}
...
* @tc.expect:
    ...
    3. Update operation return DATA_SHARE_ERROR(-1)
*/
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Silent_Update_Test001, TestSize.Level1)
{
    ...
    EXPECT_EQ(retUpdate, DATA_SHARE_ERROR);
    LOG_INFO("NormalApp_Silent_Update_Test001::End");
}

/**
 * @tc.name: NormalApp_Silent_Query_Test001
 * @tc.desc: Verify silent access Query operation behavior when caller is normal app and provider not in allowList
 * @tc.type: FUNC
 * @tc.require: gitcode#852
 * @tc.precon: Test process is set to be equivalent to a normal app
 * @tc.step:
...
* @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. Insert operation return greater than 0(success)
    3. Query operation return a nullptr resultSet(failure)
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Silent_Query_Test001, TestSize.Level0)
{
    LOG_INFO("NormalApp_Silent_Query_Test001::Start");
    auto originalToken = GetSelfTokenID();
    // Set system app
    SetSelfSystemAPP();
    ...
    LOG_INFO("NormalApp_Silent_Query_Test001::End");
}

/**
* @tc.name: NormalApp_Silent_Delete_Test001
* @tc.desc: Verify silent access Delete operation behavior when caller is normal app and provider not in allowList
* @tc.type: FUNC
* @tc.require: gitcode#852
* @tc.precon: None
* @tc.step:
...
* @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. Delete operation return DATA_SHARE_ERROR(-1)
*/
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Silent_Delete_Test001, TestSize.Level1)
{
    LOG_INFO("NormalApp_Silent_Delete_Test001::Start");
    auto helper = CreateDataShareHelper(STORAGE_MANAGER_MANAGER_ID, SILENT_ACCESS_URI);
    ASSERT_TRUE(helper != nullptr);
    Uri uri(SILENT_ACCESS_URI);
    ...
    EXPECT_EQ(retDelete, DATA_SHARE_ERROR);
    LOG_INFO("NormalApp_Silent_Delete_Test001::End");
}

/**
 * @tc.name: NormalApp_Silent_InsertEx_Test001
 * @tc.desc: Verify silent access InsertEx operation behavior when caller is normal app and provider not in allowList
 * @tc.type: FUNC
 * @tc.require: gitcode#852
 * @tc.precon: Test process is set to be equivalent to a normal app
 * @tc.step:
 ...
 * @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. InsertEx operation return <E_NOT_SYSTEM_APP(1069), 0>(failure)
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Silent_InsertEx_Test001, TestSize.Level0)
{
    LOG_INFO("NormalApp_Silent_InsertEx_Test001::Start");
    auto helper = CreateDataShareHelper(STORAGE_MANAGER_MANAGER_ID, SILENT_ACCESS_URI);
    ASSERT_TRUE(helper != nullptr);
    ...
    EXPECT_EQ(retInsertEx, 0);
    LOG_INFO("NormalApp_Silent_InsertEx_Test001::End");
}

/**
* @tc.name: NormalApp_Silent_UpdateEx_Test001
* @tc.desc: Verify silent access UpdateEx operation behavior when caller is normal app and provider not in allowList
* @tc.type: FUNC
* @tc.require: gitcode#852
* @tc.precon: Test process is set to be equivalent to a normal app
* @tc.step:
    ...
    4. Set self back to normal app
    5. Define update predicates to target data Inserted in step 3
    3. Prepare update data in a DataShareValuesBucket and call UpdateEx function
* @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. Insert operation return greater than 0(success)
    3. UpdateEx operation return <E_NOT_SYSTEM_APP(1069), 0>(failure)
*/
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Silent_UpdateEx_Test001, TestSize.Level1)
{
    LOG_INFO("NormalApp_Silent_UpdateEx_Test001::Start");
    auto originalToken = GetSelfTokenID();
    // Set system app
    SetSelfSystemAPP();
    ...
    EXPECT_EQ(errCode, E_NOT_SYSTEM_APP);
    EXPECT_EQ(retUpdateEx, 0);
    LOG_INFO("NormalApp_Silent_UpdateEx_Test001::End");
}

/**
* @tc.name: NormalApp_Silent_DeleteEx_Test001
* @tc.desc: Verify silent access DeleteEx operation behavior when caller is normal app and provider not in allowList
* @tc.type: FUNC
* @tc.require: gitcode#852
* @tc.precon: None
* @tc.step:
...
* @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. DeleteEx operation return <E_NOT_SYSTEM_APP(1069), 0>(failure)
*/
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Silent_DeleteEx_Test001, TestSize.Level1)
{
    LOG_INFO("NormalApp_Silent_DeleteEx_Test001::Start");
    auto helper = CreateDataShareHelper(STORAGE_MANAGER_MANAGER_ID, SILENT_ACCESS_URI);
    ASSERT_TRUE(helper != nullptr);
    Uri uri(SILENT_ACCESS_URI);
    ...
    LOG_INFO("NormalApp_Silent_DeleteEx_Test001::End");
}
 ...
 * @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. Insert operation return PERMISSION_ERR_CODE(-2)
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_Insert_Test001, TestSize.Level0)
{
    ...
    EXPECT_EQ(retVal, PERMISSION_ERR_CODE);
    LOG_INFO("NormalApp_Active_Insert_Test001::End");
}

/**
* @tc.name: NormalApp_Active_Update_Test001
* @tc.desc: Verify silent Active(non-silent) Update operation behavior when caller is normal app and
...
* @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. Insert operation return greater than 0(success)
    3. Update operation return PERMISSION_ERR_CODE(-2)
*/
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_Update_Test001, TestSize.Level1)
{
    LOG_INFO("NormalApp_Active_Update_Test001::Start");
    auto originalToken = GetSelfTokenID();
    // Set system app
    SetSelfSystemAPP();
    Uri uri(DATA_SHARE_URI);
    ...
    EXPECT_EQ(retUpdate, PERMISSION_ERR_CODE);
    LOG_INFO("NormalApp_Active_Update_Test001::End");
}

/**
 * @tc.name: NormalApp_Active_Query_Test001
 * @tc.desc: Verify Active(non-silent) access Query operation behavior when caller is normal app and
    provider not in allowList
 * @tc.type: FUNC
 * @tc.require: gitcode#852
 * @tc.precon: Test process is set to be equivalent to a normal app
...
* @tc.expect:
    ...
    3. Query operation return a nullptr resultSet(failure)
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_Query_Test001, TestSize.Level0)
{
    LOG_INFO("NormalApp_Active_Query_Test001::Start");
    auto originalToken = GetSelfTokenID();
    // Set system app
    SetSelfSystemAPP();
    Uri uri(DATA_SHARE_URI);
    ...
    LOG_INFO("NormalApp_Active_Query_Test001::End");
}

/**
* @tc.name: NormalApp_Active_Delete_Test001
* @tc.desc: Verify Active(non-silent) access Delete operation behavior when caller is normal app and
    provider not in allowList
* @tc.type: FUNC
* @tc.require: gitcode#852
* @tc.precon: None
...
* @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. Delete operation return PERMISSION_ERR_CODE(-2)
*/
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_Delete_Test001, TestSize.Level1)
{
    LOG_INFO("NormalApp_Active_Delete_Test001::Start");
    Uri uri(DATA_SHARE_URI);
    ...
    EXPECT_EQ(retDelete, PERMISSION_ERR_CODE);
    LOG_INFO("NormalApp_Active_Delete_Test001::End");
}

/**
 * @tc.name: NormalApp_Active_InsertEx_Test001
 * @tc.desc: Verify Active(non-silent) access InsertEx operation behavior when caller is normal app and
    provider not in allowList
 * @tc.type: FUNC
 * @tc.require: gitcode#852
 * @tc.precon: Test process is set to be equivalent to a normal app
 ...
 * @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. InsertEx operation return <PERMISSION_ERR_CODE(-2), 0>(failure)
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_InsertEx_Test001, TestSize.Level0)
{
    LOG_INFO("NormalApp_Active_InsertEx_Test001::Start");
    Uri uri(SILENT_ACCESS_URI);
    ...
    EXPECT_EQ(errCode, PERMISSION_ERR_CODE);
    EXPECT_EQ(retInsertEx, 0);
    LOG_INFO("NormalApp_Active_InsertEx_Test001::End");
}

/**
* @tc.name: NormalApp_Active_UpdateEx_Test001
* @tc.desc: Verify Active(non-silent) access UpdateEx operation behavior when caller is normal app and
    provider not in allowList
* @tc.type: FUNC
* @tc.require: gitcode#852
* @tc.precon: Test process is set to be equivalent to a normal app
...
* @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. Insert operation return greater than 0(success)
    3. UpdateEx operation return <PERMISSION_ERR_CODE(-2), 0>(failure)
*/
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_UpdateEx_Test001, TestSize.Level1)
{
    LOG_INFO("NormalApp_Active_UpdateEx_Test001::Start");
    auto originalToken = GetSelfTokenID();
    // Set system app
    SetSelfSystemAPP();
    ...
    EXPECT_EQ(errCode, PERMISSION_ERR_CODE);
    EXPECT_EQ(retUpdateEx, 0);
    LOG_INFO("NormalApp_Active_UpdateEx_Test001::End");
}

/**
* @tc.name: NormalApp_Active_DeleteEx_Test001
* @tc.desc: Verify Active(non-silent) access DeleteEx operation behavior when caller is normal app and
    provider not in allowList
* @tc.type: FUNC
* @tc.require: gitcode#852
* @tc.precon: None
...
* @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. DeleteEx operation return <PERMISSION_ERR_CODE(-2), 0>(failure)
*/
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_DeleteEx_Test001, TestSize.Level1)
{
    LOG_INFO("NormalApp_Active_DeleteEx_Test001::Start");
    Uri uri(SILENT_ACCESS_URI);
    ...
    auto [errCode, retDeleteEx] = g_exHelper->DeleteEx(uri, deletePredicates);
    EXPECT_EQ(errCode, PERMISSION_ERR_CODE);
    EXPECT_EQ(retDeleteEx, 0);
    LOG_INFO("NormalApp_Active_DeleteEx_Test001::End");
}

/**
 * @tc.name: NormalApp_Active_BatchInsert_Test001
 * @tc.desc: Verify Active(non-silent) access BatchInsert operation behavior when caller is normal app and
    provider not in allowList
 * @tc.type: FUNC
 * @tc.require: gitcode#852
 * @tc.precon: Test process is set to be equivalent to a normal app
 * @tc.step:
    1. Create a DataShareHelper instance with non-silent access configuration
    2. Prepare test data in a std::vector<DataShareValuesBucket>
    3. Perform BatchInsert operation and verify result
 * @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. BatchInsert operation returns PERMISSION_ERR_CODE(-2)
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_BatchInsert_Test001, TestSize.Level0)
{
    LOG_INFO("NormalApp_Active_BatchInsert_Test001::Start");
    Uri uri(SILENT_ACCESS_URI);

    DataShare::DataShareValuesBucket valuesBucket1;
    DataShare::DataShareValuesBucket valuesBucket2;

    valuesBucket1.Put("name", "NormalApp_Active_BatchInsert_Test001");
    valuesBucket2.Put("name", "NormalApp_Active_BatchInsert_Test001_2");
    std::vector<DataShareValuesBucket> vBuckets = { valuesBucket1, valuesBucket2 };

    auto retBatchInsert = g_exHelper->BatchInsert(uri, vBuckets);
    EXPECT_EQ(retBatchInsert, PERMISSION_ERR_CODE);
    LOG_INFO("NormalApp_Active_BatchInsert_Test001::End");
}

/**
 * @tc.name: NormalApp_Active_BatchUpdate_Test001
 * @tc.desc: Verify Active(non-silent) access BatchUpdate operation behavior when caller is normal app and
    provider not in allowList
 * @tc.type: FUNC
 * @tc.require: gitcode#852
 * @tc.precon: Test process is set to be equivalent to a normal app
 ...
 * @tc.expect:
    1. DataShareHelper is created successfully(not nullptr)
    2. BatchUpdate operation returns PERMISSION_ERR_CODE(-2) and result size is 0
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_BatchUpdate_Test001, TestSize.Level0)
{
    LOG_INFO("NormalApp_Active_BatchUpdate_Test001::Start");
    Uri uri(SILENT_ACCESS_URI);
    ...
    EXPECT_EQ(retBatchUpdate, PERMISSION_ERR_CODE);
    EXPECT_EQ(results.size(), 0);
    LOG_INFO("NormalApp_Active_BatchUpdate_Test001::End");
}

/**
 * @tc.name: NormalApp_Silent_VerifiedProvider_Test001
 * @tc.desc: Verify silent access Query operation behavior when caller is normal app and provider in allowList
 * @tc.type: FUNC
 * @tc.require: gitcode#852
 * @tc.precon: Test process is set to be equivalent to a normal app
 * @tc.step:
 ...
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Silent_VerifiedProvider_Test001, TestSize.Level0)
{
    LOG_INFO("NormalApp_Silent_VerifiedProvider_Test001::Start");
    ...
    resultSet->Close();
    LOG_INFO("NormalApp_Silent_VerifiedProvider_Test001::End");
}

/**
 * @tc.name: NormalApp_Active_VerifiedProvider_Test001
 * @tc.desc: Verify Active(non-silent) access Insert, Update and Delete operation behavior when caller
    is normal app and provider in allowList
 * @tc.type: FUNC
 * @tc.require: gitcode#852
 * @tc.precon: Test process is set to be equivalent to a normal app, helper created using settingsdata
    non-silent uri.
 * @tc.step:
    1. Create a DataShareHelper instance with non-silent access configuration
 ...
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_VerifiedProvider_Test001, TestSize.Level0)
{
    LOG_INFO("NormalApp_Active_VerifiedProvider_Test001::Start");
    Uri uri(VERIFIED_QUERY_URI);

    DataShare::DataShareValuesBucket valuesBucket;
    valuesBucket.Put(TBL_SETTINGS_COL1, "NormalApp_Active_VerifiedProvider_Test001");
    valuesBucket.Put(TBL_SETTINGS_COL2, "DataShareStubImplNormalTest");
    int retVal = settings_exHelper->Insert(uri, valuesBucket);
    EXPECT_NE(retVal, PERMISSION_ERR_CODE);

    DataShare::DataSharePredicates predicates;
    std::string selections = TBL_SETTINGS_COL1 + " = 'NormalApp_Active_VerifiedProvider_Test001'";
    predicates.SetWhereClause(selections);
    DataShare::DataShareValuesBucket valuesBucket1;
    valuesBucket1.Put(TBL_SETTINGS_COL2, "DataShareStubImplNormalTest1");
    int retUpdate = settings_exHelper->Update(uri, predicates, valuesBucket1);
    EXPECT_NE(retUpdate, PERMISSION_ERR_CODE);

    DataShare::DataSharePredicates deletePredicates;
    std::string selectionsDelete = TBL_SETTINGS_COL2 + " = 'DataShareStubImplNormalTest1'";
    ...
    LOG_INFO("NormalApp_Active_VerifiedProvider_Test001::End");
}

/**
 * @tc.name: NormalApp_Active_VerifiedProvider_Test002
 ...
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_VerifiedProvider_Test002, TestSize.Level0)
{
    LOG_INFO("NormalApp_Active_VerifiedProvider_Test002::Start");
    Uri uri(VERIFIED_QUERY_URI);

    DataShare::DataShareValuesBucket valuesBucket;
    valuesBucket.Put(TBL_SETTINGS_COL1, "NormalApp_Active_VerifiedProvider_Test002");
    valuesBucket.Put(TBL_SETTINGS_COL2, "DataShareStubImplNormalTest");
    auto [errCode, retVal] = settings_exHelper->InsertEx(uri, valuesBucket);
    EXPECT_NE(errCode, PERMISSION_ERR_CODE);

    DataShare::DataSharePredicates predicates;
    std::string selections = TBL_SETTINGS_COL1 + " = 'NormalApp_Active_VerifiedProvider_Test002'";
    predicates.SetWhereClause(selections);
    DataShare::DataShareValuesBucket valuesBucket1;
    valuesBucket1.Put(TBL_SETTINGS_COL2, "DataShareStubImplNormalTest1");
    ...
    LOG_INFO("NormalApp_Active_VerifiedProvider_Test002::End");
}

/**
 * @tc.name: NormalApp_Active_VerifiedProvider_Test003
 * @tc.desc: Verify Active(non-silent) access BatchInsert and BatchUpdate operation behavior when
    caller is normal app and provider in allowList
 * @tc.type: FUNC
 * @tc.require: gitcode#852
 * @tc.precon: Test process is set to be equivalent to a normal app, helper created using settingsdata
    non-silent uri.
 ...
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_VerifiedProvider_Test003, TestSize.Level0)
{
    LOG_INFO("NormalApp_Active_VerifiedProvider_Test003::Start");
    Uri uri(VERIFIED_QUERY_URI);

    DataShare::DataShareValuesBucket valuesBucket1;
    DataShare::DataShareValuesBucket valuesBucket2;

    valuesBucket1.Put(TBL_SETTINGS_COL1, "NormalApp_Active_VerifiedProvider_Test003");
    valuesBucket2.Put(TBL_SETTINGS_COL1, "NormalApp_Active_VerifiedProvider_Test003_2");
    std::vector<DataShareValuesBucket> vBuckets = { valuesBucket1, valuesBucket2 };
    ...
    updateOperation1.predicates.EqualTo(TBL_SETTINGS_COL1, "NormalApp_Active_VerifiedProvider_Test003");
    updateOperations1.push_back(updateOperation1);
 
    std::vector<DataShare::UpdateOperation> updateOperations2;
    DataShare::UpdateOperation updateOperation2;
    updateOperation2.valuesBucket.Put(TBL_SETTINGS_COL2, "undefined1");
    updateOperation2.predicates.EqualTo(TBL_SETTINGS_COL1, "NormalApp_Active_VerifiedProvider_Test003_2");
    updateOperations1.push_back(updateOperation2);
    updateOperations2.push_back(updateOperation2);
    ...
    EXPECT_EQ(results.size(), 0);
    LOG_INFO("NormalApp_Active_VerifiedProvider_Test003::End");
}

/**
 * @tc.name: NormalApp_Active_VerifiedProviderQuery_Test001
 * @tc.desc: Verify Active(non-silent) access Query operation behavior when caller is normal app and
...
* @tc.expect:
    ...
    2. Query operation return a non-null resultSet and rowcount is greater than 0(success)
 */
HWTEST_F(DataShareStubImplNormalTest, NormalApp_Active_VerifiedProviderQuery_Test001, TestSize.Level0)
{
    LOG_INFO("NormalApp_Active_VerifiedProviderQuery_Test001::Start");
    ...
    EXPECT_TRUE(totalRow > 0);
    resultSet->Close();
    LOG_INFO("NormalApp_Active_VerifiedProviderQuery_Test001::End");
}
}
}