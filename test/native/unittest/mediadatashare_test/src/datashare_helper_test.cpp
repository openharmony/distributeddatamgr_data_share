...
/**
 * @tc.name: DataShareHelper_CreatorTest001
...
/**
 * @tc.name: DataShareHelper_CreatorTest002
...
/**
 * @tc.name: DataShareHelper_CreatorTest004
 * @tc.desc: Test the Creator function of DataShareHelper when CreateOptions.isProxy_ is true and CreateOptions.token_
...
/**
 * @tc.name: DataShareHelper_CreateExtHelper001
...
/**
 * @tc.name: DataShareHelper_SetSilentSwitch001
...
/**
 * @tc.name: DataShareHelper_GetSilentProxyStatus001
...
/**
 * @tc.name: DataShareHelper_CreateServiceHelper001
